...
static void resize_event(gx_shakatubeUI * const ui);
...
static void _expose(const gx_shakatubeUI * const ui) {
...
static void controller_expose(const gx_shakatubeUI * const ui,  const gx_controller * const control) {
	cairo_push_group (ui->cr);
...
static void reset_request(gx_shakatubeUI * const ui) {
...
static bool get_active_ctl_num(gx_shakatubeUI * const ui, int *num) {
	bool ret = false;
	for (int i=0;i<CONTROLS;i++) {
...
static void scroll_event(gx_shakatubeUI * const ui, int direction) {
	float value;
	int num;
...
static void button1_event(gx_shakatubeUI * const ui, double* start_value) {
	int num;
...
static void motion_event(gx_shakatubeUI * const ui, double start_value, int m_y) {
...
static void set_key_value(gx_shakatubeUI * const ui, int set_value) {
	float value = 0.0;
	int num;
	if (get_active_controller_num(ui, &num)) {
...
static void key_event(gx_shakatubeUI * const ui, int direction) {
	float value;
	int num;
	if (get_active_controller_num(ui, &num)) {
		value = min(ui->controls[num].adj.max_value,max(ui->controls[num].adj.min_value, 
...
static void set_previous_controller_active(gx_shakatubeUI * const ui) {
	int num;
	if (get_active_controller_num(ui, &num)) {
...
static void set_next_controller_active(gx_shakatubeUI * const ui) {
	int num;
	if (get_active_controller_num(ui, &num)) {
		ui->controls[num].is_active = false;
		send_controller_event(ui, num);
...
static void get_last_active_controller(gx_shakatubeUI * const ui, bool set) {
	int num;
	if (get_active_controller_num(ui, &num)) {
...
static void event_handler(gx_shakatubeUI * const ui) {
	XEvent xev;
